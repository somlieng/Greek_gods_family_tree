...
//level 2 gods
let Gaia = new God("Gaia",centers.large,level2,"img/Gaia.png",largeCard.width,largeCard.height,largeCard.type,godType.earth,domain.Gaia,description.Gaia);
let Tartarus = new God("Tartarus",Gaia.x-(cardSpace*2),level2,"img/Tartarus.png",regularCard.width,regularCard.height,regularCard.type,godType.underworld,domain.Tartarus,description.Tartarus);
let ErosElder = new God("Eros-Elder",Tartarus.x-cardSpace*2,level2,"img/Eros_Elder.png",regularCard.width,regularCard.height,regularCard.type,godType.personification,domain.ErosElder,description.ErosElder);
let Erebus = new God("Erebus",Gaia.x+(cardSpace*2),level2,"img/Erebus.png",regularCard.width,regularCard.height,regularCard.type,godType.underworld,domain.Erebus,description.Erebus);
let Nyx = new God("Nyx",Erebus.x+cardSpace*2,level2,"img/Nyx.png",regularCard.width,regularCard.height,regularCard.type,godType.underworld,domain.Nyx,description.Nyx);

let level3 = Gaia.y+cardAbove;

//level 3 gods
let Uranus = new God("Uranus",centers.large,level3,"img/Uranus.png",largeCard.width,largeCard.height,largeCard.type,godType.sky,domain.Uranus,description.Uranus);
let Ourea = new God("Ourea",centers.regular-cardSpace-40,level3,"img/Ourea.png",regularCard.width,regularCard.height,regularCard.type,godType.earth,domain.Ourea,description.Ourea);
let Pontus = new God("Pontus",centers.regular+cardSpace+20,level3,"img/Pontus.png",regularCard.width,regularCard.height,regularCard.type,godType.water,domain.Pontus,description.Pontus);
...
let Charon = new God("Charon",Hemera.x+cardSpace,level3,"img/Charon.png",regularCard.width,regularCard.height,regularCard.type,godType.underworld,domain.Charon,description.Charon);
...
let Colchian = new God("Colchian-Dragon",(Typhon.x+Echidna.x)/2-cardSpace/2,level3+regularCard.height+100,"img/Colchian.png",regularCard.width,regularCard.height,regularCard.type,godType.monster,domain.Colchian,description.Colchian);
let Chimera = new God("Chimera",(Typhon.x+Echidna.x)/2+cardSpace/2,level3+regularCard.height+100,"img/Chimera.png",regularCard.width,regularCard.height,regularCard.type,godType.monster,domain.Chimera,description.Chimera);
let Hydra = new God("Hydra",Chimera.x+cardSpace,level3+regularCard.height+100,"img/Hydra.png",regularCard.width,regularCard.height,regularCard.type,godType.monster,domain.Hydra,description.Hydra);
let Sphinx = new God("Sphinx",Hydra.x+cardSpace,level3+regularCard.height+100,"img/Sphinx.png",regularCard.width,regularCard.height,regularCard.type,godType.monster,domain.Sphinx,description.Sphinx);
let Cerebus = new God("Cerebus",Colchian.x-cardSpace,level3+regularCard.height+100,"img/Cerebus.png",regularCard.width,regularCard.height,regularCard.type,godType.underworld,domain.Cerebus,description.Cerebus);
let Orthrus = new God("Orthrus",Cerebus.x-cardSpace,level3+regularCard.height+100,"img/Orthrus.png",regularCard.width,regularCard.height,regularCard.type,godType.monster,domain.Orthrus,description.Orthrus);
let Cyclops = new God("Cyclops",centers.large-20,level3+cardAbove,"null",smallCard.width,smallCard.height,smallCard.type,godType.monster,domain.Cyclops,description.Cyclops);
let Hecatoncheires = new God("Hecatoncheires",centers.large-20,Cyclops.y+smallCard.height+betweenCards,"null",smallCard.width,smallCard.height,smallCard.type,godType.monster,domain.Hecatoncheires,description.Hecatoncheires);
let Giantes = new God("Giantes",Cyclops.x+smallCard.width+betweenCards+20,level3+cardAbove,null,smallCard.width,smallCard.height,smallCard.type,godType.monster,domain.Giantes,description.Giantes);
let Erinyes = new God("Erinyes",Cyclops.x+smallCard.width+betweenCards+20,Giantes.y+smallCard.height+betweenCards,null,smallCard.width,smallCard.height,smallCard.type,godType.underworld,domain.Erinyes,description.Erinyes);
let Meliae = new God("Meliaes",Cyclops.x+smallCard.width+betweenCards+20,Erinyes.y+smallCard.height+betweenCards,null,smallCard.width,smallCard.height,smallCard.type,godType.earth,domain.Meliae,description.Meliae);
let Iris = new God("Iris",Aether.x,level4,"img/Iris.png",regularCard.width,regularCard.height,regularCard.type,godType.sky,domain.Iris,description.Iris);
let Harpies = new God("Harpies",Iris.x+cardSpace,level4,"img/Harpies.png",regularCard.width,regularCard.height,regularCard.type,godType.monster,domain.Harpies,description.Harpies);
let Gorgons = new God("Gorgons",Harpies.x+cardSpace,level4,"img/Gorgons.png",regularCard.width,regularCard.height,regularCard.type,godType.monster,domain.Gorgons,description.Gorgons);
let Graeae = new God("Graeae",Gorgons.x+cardSpace,level4,"img/Graeae.png",regularCard.width,regularCard.height,regularCard.type,godType.monster,domain.Graeae,description.Graeae);
let Thamus = new God("Thamus",Thalassa.x,level4-110,null,smallCard.width,smallCard.height,smallCard.type,godType.water,domain.Thamus,description.Thamus);
let Phorcys = new God("Phorcys",Gorgons.x,level4-110,null,smallCard.width,smallCard.height,smallCard.type,godType.water,domain.Phorcys,description.Phorcys);
let Ceto = new God("Ceto",Graeae.x,level4-110,null,smallCard.width,smallCard.height,smallCard.type,godType.water,domain.Ceto,description.Ceto);
let Scylla = new God("Scylla",Graeae.x+cardSpace,level4,"img/Scylla.png",regularCard.width,regularCard.height,regularCard.type,godType.monster,domain.Scylla,description.Scylla);

//level 5 gods
let Kronos = new God("Kronos",(centers.large-cardWidth/2)-cardSpace/2,level5,"img/Kronos.png",largeCard.width,largeCard.height,largeCard.type,godType.earth,domain.Kronos,description.Kronos);
let Rhea = new God("Rhea",(centers.large+cardWidth/2)+cardSpace/2,level5,"img/Rhea.png",largeCard.width,largeCard.height,largeCard.type,godType.earth,domain.Rhea,description.Rhea);
...
let Crius = new God("Crius",Eurybia.x-cardSpace,level5,"img/Crius.png",regularCard.width,regularCard.height,regularCard.type,godType.sky,domain.Crius,description.Crius);
let Theia = new God("Theia",Crius.x-cardSpace,level5,"img/Theia.png",regularCard.width,regularCard.height,regularCard.type,godType.sky,domain.Theia,description.Theia);
let Hyperion = new God("Hyperion",Theia.x-cardSpace,level5,"img/Hyperion.png",regularCard.width,regularCard.height,regularCard.type,godType.sky,domain.Hyperion,description.Hyperion);
let Tethys = new God("Tethys",Hyperion.x-cardSpace,level5,"img/Tethys.png",regularCard.width,regularCard.height,regularCard.type,godType.water,domain.Tethys,description.Tethys);
let Oceanus = new God("Oceanus",Tethys.x-cardSpace,level5,"img/Oceanus.png",regularCard.width,regularCard.height,regularCard.type,godType.water,domain.Oceanus,description.Oceanus);
let Themis = new God("Themis",Rhea.x+cardSpace*2,level5,"img/Themis.png",regularCard.width,regularCard.height,regularCard.type,godType.personification,domain.Themis,description.Themis);
let Asia = new God("Asia",Themis.x+cardSpace,level5,"null",smallCard.width,smallCard.height,smallCard.type,godType.water,domain.Asia,description.Asia);
let Iapetus = new God("Iapetus",Asia.x+cardSpace,level5,"img/Iapetus.png",regularCard.width,regularCard.height,regularCard.type,godType.personification,domain.Iapetus,description.Iapetus);
let Mnemosyne = new God("Mnemosyne",Iapetus.x+cardSpace,level5,"img/Mnemosyne.png",regularCard.width,regularCard.height,regularCard.type,godType.personification,domain.Mnmosyne,description.Mnmosyne);
let Coeus = new God("Coeus",Mnemosyne.x+cardSpace*2,level5,"img/Coeus.png",regularCard.width,regularCard.height,regularCard.type,godType.sky,domain.Coeus,description.Coeus);
let Phoebe = new God("Phoebe",Coeus.x+cardSpace,level5,"img/Phoebe.png",regularCard.width,regularCard.height,regularCard.type,godType.sky,domain.Phoebe,description.Phoebe);
...
let Nereus = new God("Nereus",Oceanus.x-cardSpace*2,level6,"img/Nereus.png",regularCard.width,regularCard.height,regularCard.type,godType.water,domain.Nereus,description.Nereus);
let Doris = new God("Doris",Nereus.x+cardSpace,level6+largeCard.height/2+20,null,smallCard.width,smallCard.height,smallCard.type,godType.water,domain.Doris,description.Doris);
let Helios = new God("Helios",Hyperion.x,level6+20,"img/Helios.png",regularCard.width,regularCard.height,regularCard.type,godType.sky,domain.Helios,description.Helios);
let Selene = new God("Selene",Helios.x+cardSpace,level6+20,"img/Selene.png",regularCard.width,regularCard.height,regularCard.type,godType.sky,domain.Selene,description.Selene);
let Eos = new God("Eos",Selene.x+cardSpace,level6+20,"img/corgi.jpeg",smallCard.width,smallCard.height,smallCard.type,godType.sky,domain.Eos,description.Eos);
let Astraeus = new God("Astraeus",Eos.x+cardSpace,level6+20,"img/corgi.jpeg",smallCard.width,smallCard.height,smallCard.type,godType.sky,domain.Astraeus,description.Astraeus);
let Anemoi = new God("Anemoi",Selene.x+cardSpace,level6+cardSpaceSmall,null,smallCard.width,smallCard.height,smallCard.type,godType.sky,domain.Anemoi,description.Anemoi);
...
let Atlas = new God("Atlas",(Asia.x+Iapetus.x)/2+betweenCards,level6+40,"img/Atlas.png",regularCard.width,regularCard.height,regularCard.type,godType.sky,domain.Atlas,description.Atlas);
let Prometheus = new God("Prometheus",Atlas.x+cardSpace,level6+40,"img/Prometheus.png",regularCard.width,regularCard.height,regularCard.type,godType.personification,domain.Prometheus,description.Prometheus);
let Epimetheus = new God("Epimetheus",Prometheus.x+cardSpace,level6+40,"img/Epimetheus.png",regularCard.width,regularCard.height,regularCard.type,godType.personification,domain.Epimetheus,description.Epimetheus);
let Pandora = new God("Pandora",Epimetheus.x+cardSpace,level6+40,"img/Pandora.png",regularCard.width,regularCard.height,regularCard.type,godType.mortal,domain.Pandora,description.Pandora);
let Pleione = new God("Pleione",Atlas.x-cardSpace,level6+cardSpaceSmall,null,smallCard.width,smallCard.height,smallCard.type,godType.water,domain.Pleione,description.Pleione);
let Tyche = new God("Tyche",Doris.x+cardSpaceSmall-40,level6A-10,null,smallCard.width,smallCard.height,smallCard.type,godType.water,domain.Tyche,description.Tyche);
let Perse = new God("Perseis",Tyche.x+cardSpaceSmall-40,level6A+60,null,smallCard.width,smallCard.height,smallCard.type,godType.water,domain.Perse,description.Perse);
let Pallas = new God("Pallas",Astraeus.x+100,level6A+60,"img/corgi.jpeg",smallCard.width,smallCard.height,smallCard.type,godType.personification,domain.Pallas,description.Pallas);
let Styx = new God("Styx",Anemoi.x,level6A+60,"img/corgi.jpeg",smallCard.width,smallCard.height,smallCard.type,godType.underworld,domain.Styx,description.Styx);
let Perses = new God("Perses",Pallas.x+smallCard.width-30,level6+cardSpaceSmall,"img/corgi.jpeg",smallCard.width,smallCard.height,smallCard.type,godType.personification,domain.Perses,description.Perses);
...
let Hera = new God("Hera",(centers.large+cardWidth/2)+cardSpace/2,level7,"img/Hera.png",largeCard.width,largeCard.height,largeCard.type,godType.sky,domain.Hera,description.Hera);
let Hades = new God("Hades",Hera.x+cardSpace*2.5,level7,"img/Hades.png",largeCard.width,largeCard.height,largeCard.type,godType.underworld,domain.Hades,description.Hades);
let Hestia = new God("Hestia",Hades.x+cardSpace*2.5,level7,"img/Hestia.png",largeCard.width,largeCard.height,largeCard.type,godType.personification,domain.Hestia,description.Hestia);
let Demeter = new God("Demeter",Zeus.x-cardSpace*2.5,level7,"img/Demeter.png",largeCard.width,largeCard.height,largeCard.type,godType.earth,domain.Demeter,description.Demeter);
let Poseidon = new God("Poseidon",Demeter.x-cardSpace*2.5,level7,"img/Poseidon.png",largeCard.width,largeCard.height,largeCard.type,godType.water,domain.Poseidon,description.Poseidon);
let Amphitrite = new God("Amphitrite",Nereus.x+regularCard.width/2,level7,"img/Amphitrite.png",regularCard.width,regularCard.height,regularCard.type,godType.water,domain.Amphitrite,description.Amphitrite);
...
let Methis = new God("Methis",Eurynome.x+cardSpaceSmall-20,level7A-120,"img/corgi.jpeg",smallCard.width,smallCard.height,smallCard.type,godType.water,domain.Methis,description.Methis);
let Maia = new God("Maia",(Hades.x+Hestia.x)/2,level7+largeCard.height/2,"img/corgi.jpeg",smallCard.width,smallCard.height,smallCard.type,godType.sky,domain.Maia,description.Maia);
...
let Asteria = new God("Asteria",Leto.x+cardSpace+20,level7A,"img/corgi.jpeg",smallCard.width,smallCard.height,smallCard.type,godType.sky,domain.Asteria,description.Asteria);

let level8 = Zeus.y+cardAbove*1.5;

//level 8 gods
let Ares = new God("Ares",(centers.large)+cardSpace,level8,"img/Ares.png",largeCard.width,largeCard.height,largeCard.type,godType.personification,domain.Ares,description.Ares);
let Aphrodite = new God("Aphrodite",Ares.x+cardSpace,level8,"img/Aphrodite.png",largeCard.width,largeCard.height,largeCard.type,godType.personification,domain.Aphrodite,description.Aphrodite);
...
let Artemis = new God("Artemis",Apollo.x+cardSpace,level8,"img/Artemis.png",largeCard.width,largeCard.height,largeCard.type,godType.earth,domain.Artemis,description.Artemis);
...
let Eirene = new God("Eirene",Eunomia.x+cardSpace,level9,"img/Eirene.png",regularCard.width,regularCard.height,regularCard.type,godType.personification,domain.Eirene,description.Eirene);
...
function makeTextWrap(){
    ...
    tree.select('#domain-Eros-Elder')
        .call(wrap, regular);
    tree.select('#domain-Orthrus')
        .call(wrap,regular);
    tree.select('#domain-Cerebus')
        .call(wrap,regular);
    tree.select('#domain-Colchian-Dragon')
        .call(wrap,regular);
    tree.select('#domain-Chimera')
        .call(wrap,regular);
    tree.select('#domain-Hydra')
        .call(wrap,regular);
    tree.select('#domain-Sphinx')
        .call(wrap,regular);
    tree.select('#domain-Charon')
        .call(wrap,regular);
    tree.select('#domain-Iris')
        .call(wrap,regular);
    tree.select('#domain-Harpies')
        .call(wrap,regular);
    tree.select('#domain-Gorgons')
        .call(wrap,regular);
    tree.select('#domain-Graeae')
        .call(wrap,regular);
    tree.select('#domain-Nereus')
        .call(wrap,regular);
    tree.select('#domain-Oceanus')
        .call(wrap,regular);
    tree.select('#domain-Tethys')
        .call(wrap,regular);
    tree.select('#domain-Theia')
        .call(wrap,regular);
    tree.select('#domain-Crius')
        .call(wrap,regular);
    tree.select('#domain-Kronos')
        .call(wrap,regular);
    tree.select('#domain-Rhea')
        .call(wrap,regular);
    tree.select('#domain-Themis')
        .call(wrap,regular);
    tree.select('#domain-Iapetus')
        .call(wrap,regular);
    tree.select('#domain-Mnemosyne')
        .call(wrap,regular);
    tree.select('#domain-Coeus')
        .call(wrap,regular);
    tree.select('#domain-Phoebe')
        .call(wrap,regular);
    tree.select('#domain-Epimetheus')
        .call(wrap,regular);
    tree.select('#domain-Prometheus')
        .call(wrap,regular);
    tree.select('#domain-Atlas')
        .call(wrap,regular);
    tree.select('#domain-Amphitrite')
        .call(wrap,regular);
    tree.select('#domain-Demeter')
        .call(wrap,large);
    tree.select('#domain-Zeus')
        .call(wrap,large);
    tree.select('#domain-Hera')
        .call(wrap,large);
    tree.select('#domain-Hades')
        .call(wrap,large);
    tree.select('#domain-Hestia')
        .call(wrap,large);
    tree.select('#domain-Triton')
        .call(wrap,regular);
    tree.select('#domain-Hebe')
        .call(wrap,regular);
    tree.select('#domain-Athena')
        .call(wrap,large);
    tree.select('#domain-Aphrodite')
        .call(wrap,large);
    tree.select('#domain-Adonis')
        .call(wrap,regular);
    tree.select('#domain-Hermes')
        .call(wrap,large);
    tree.select('#domain-Apollo')
        .call(wrap,large);
